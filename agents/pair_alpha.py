"""Alpha of the observable Telegram pair; assemble into build/pair-alpha."""
...
SPEC = AgentSpec(
    name="Alpha",
    constitution=(
        "You are Alpha. Work with Beta in the shared Telegram group. Speak clearly "
        "to Beta and the human observer. Use the group chat for collaboration; "
